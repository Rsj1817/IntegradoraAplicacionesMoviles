...
**SnaPrec** soluciona esto eliminando la barrera de la escritura manual, permitiendo gestionar la información de manera más eficiente mediante la transcripción inmediata. El sensor
para capturar el audio y procesarlo, la aplicación hace uso del **Micrófono** del dispositivo móvil e integra servicios de reconocimiento de voz.
...
| Grabación de Voz | Transcripción a Texto |
|:----------------:|:---------------------:|
| ![Pantalla Grabando](./screenshots/foto1.png) | ![Pantalla Nota](./screenshots/foto2.png) |

---

## Descarga (Releases):

Puedes descargar la última versión del ejecutable firmado (.apk) para instalarlo en tu dispositivo Android desde la sección de **[Releases de este repositorio](../../releases)**.
